...
const showDtTable = (accordionId, url) => {
  const columns = [
    ...
    { data: "status" },
    {
      ...
      render: function (data, type, row) {
        return (
          '<a href="resp-helpdesk/detail/' +
          row.id +
          '"><i class="fas fa-info btn btn-secondary rounded-circle"></i> Detail</a>'
        );
      },
    },
  ];
  ...
  $(document)
    .off("click", "#datatable-" + accordionId + " tbody td.details-control")
    .on(
      "click",
      "#datatable-" + accordionId + " tbody td.details-control",
      function () {
