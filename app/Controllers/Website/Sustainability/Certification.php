...
class Certification extends BaseController
{
    ...
    {
        $this->model = new \App\Models\Website\Sustainability\CertificationModel();
    ...
    public function index()
    {
        ...
        $certification = $this->model->getData()->getResult('\App\Entities\Certification');
        // $page = $pageModel->findAll();
        //$divisi = getDivisi();
        //$submenu = getSubmenu($moduleid=0);
		$data = [
			'title_meta' => view('partials/title-meta', ['title' => 'Sertifikasi']),
			'page_title' => view('partials/page-title', ['title' => 'Dashboard', 'li_1' => 'Website', 'li_2' => 'Sertifikasi']),
			'modules' => $menu,
            'route'=>'keberlanjutan/sertifikasi',
