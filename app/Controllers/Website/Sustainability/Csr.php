...
class Csr extends BaseController
{
    ...
    {
        $this->model = new \App\Models\Website\Sustainability\CsrModel();
    ...
    public function index()
    {
        ...
        $csr = $this->model->getData()->getResult('\App\Entities\Csr');
        // $page = $pageModel->findAll();
        //$divisi = getDivisi();
        //$submenu = getSubmenu($moduleid=0);
		$data = [
			'title_meta' => view('partials/title-meta', ['title' => 'Pengembangan Kelompok']),
			'page_title' => view('partials/page-title', ['title' => 'Dashboard', 'li_1' => 'Website', 'li_2' => 'Pengembangan Kelompok']),
			'modules' => $menu,
            'route'=>'keberlanjutan/csr',
            'menuname' => 'Pengembangan_Kelompok',
            'data' => $csr,
            'modal' => 'modal-lg',
