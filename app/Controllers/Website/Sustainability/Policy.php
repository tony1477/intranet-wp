...
class Policy extends BaseController
{
    ...
    {
        $this->model = new \App\Models\Website\Sustainability\PolicyModel();
    ...
    public function index()
    {
        ...
        $policy = $this->model->getData()->getResult('\App\Entities\Policy');
        // $page = $pageModel->findAll();
        //$divisi = getDivisi();
        //$submenu = getSubmenu($moduleid=0);
		$data = [
			'title_meta' => view('partials/title-meta', ['title' => 'Kebijakan']),
			'page_title' => view('partials/page-title', ['title' => 'Dashboard', 'li_1' => 'Website', 'li_2' => 'Kebijakan']),
			'modules' => $menu,
            'route'=>'keberlanjutan/kebijakan',
            'menuname' => 'Kebijakan',
            'data' => $policy,
            'modal' => 'modal-lg',
