...
class Osh extends BaseController
{
    private $model = null;
    public function __construct()
    {
        $this->model = new \App\Models\Website\Sustainability\OshModel();
    ...
    public function index()
    {
        ...
        $osh = $this->model->getData()->getResult('\App\Entities\Osh');
        // $page = $pageModel->findAll();
        //$divisi = getDivisi();
        //$submenu = getSubmenu($moduleid=0);
		$data = [
			'title_meta' => view('partials/title-meta', ['title' => 'OSH']),
			'page_title' => view('partials/page-title', ['title' => 'Dashboard', 'li_1' => 'Website', 'li_2' => 'OSH']),
			'modules' => $menu,
            'route'=>'keberlanjutan/osh',
            'menuname' => 'OSH',
            'data' => $osh,
            'modal' => 'modal-lg',
