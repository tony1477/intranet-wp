...
class Kebun extends BaseController
{
    ...
    {
        $this->model = new \App\Models\Website\Business\KebunModel();
    ...
    public function index()
    {
        ...
        $plantation = $this->model->getData()->getResult('\App\Entities\Kebun');
        // $page = $pageModel->findAll();
        //$divisi = getDivisi();
        //$submenu = getSubmenu($moduleid=0);
		$data = [
			'title_meta' => view('partials/title-meta', ['title' => 'Kebun']),
			'page_title' => view('partials/page-title', ['title' => 'Dashboard', 'li_1' => 'Website', 'li_2' => 'Kebun']),
			'modules' => $menu,
            'route'=>'bisnis/kebun',
            'menuname' => 'Profile',
            'data' => $plantation,
