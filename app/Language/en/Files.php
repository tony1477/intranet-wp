...
return [
    ...
    "Send_Article" => "Send Blast Article",
    "Update" => "Update",
    ...
    "Notulen_Meeting" => "Meeting Notes",
    "Title" => "Title",
    "Head_Notulen" => "Approver Notulen",
    "Key_Person" => "Key Person",
    "Detail" => "Detail",
    "Notulen_Detail" => "Notulen Detail",
    "Agenda_Topic_Others" => "Agenda/Topic, Explaination and Meeting Result, or  Subtitle",
