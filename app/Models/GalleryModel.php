...
class GalleryModel extends Model
{
    ...
    protected $allowedFields    = ['gallerytype','categoryid','url','title','description','ishighlight','islogin','iscover','status','sampul_video','createdby','updatedby'];
    ...
    public function getGalleryVideo($id)
    {
        ...
        return $this->db->table('gallery g')
            ...
            ->join('gallerycategories a','a.categoryid=g.categoryid','left')
            ->where('gallerytype',2)
            ->get();
    }
}
