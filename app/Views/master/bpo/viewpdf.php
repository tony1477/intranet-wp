...
<head>
    ...
    <!-- <meta name="content" content="<?php //var_dump($row) ?>"> -->
    ...
    <script src="https://cdn.jsdelivr.net/npm/pdfjs-dist@3.0.279/web/pdf_viewer.js" integrity="sha256-XG/nWhP0spQZl62n23o1+79vJ/je0AAGh5oAiPz9gSE=" crossorigin="anonymous"></script>
...
<script>
const downlodButton = document.querySelector('button#download')
const downlodButton1 = document.querySelector('button#secondaryDownload')
const printButton = document.querySelector('button#print')
const printButton1 = document.querySelector('button#secondaryPrint')
const openButton = document.querySelector('button#openFile')
const openButton1 = document.querySelector('button#secondaryOpenFile')
downlodButton.style.display = 'none'
downlodButton1.style.display = 'none'
