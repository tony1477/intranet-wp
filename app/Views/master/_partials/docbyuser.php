      ...
      <div class="modal-body">
        <form>
          ...
          <div class="col-xs-5 col-md-5">
              <select name="from[]" id="search" class="form-control fromdocbyuser" size="8" multiple="multiple">
                  <!-- <option value="">--</option> -->
              </select>
          </div>
          ...
          <div class="col-xs-5 col-md-5">
              <select name="to[]" id="search_to" class="form-control todocbyuser" size="8" multiple="multiple"></select>
          </div>
          </div>
        </form>
      </div>
