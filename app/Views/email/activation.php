<p>Congratulation!!. <br />This is activation email for your account (<?=$email?>) on <?= site_url() ?>.</p>

<p>To Use your account use this URL.</p>

<p><a href="<?= base_url()?>/login">Wilian Perkasa Intranet</a>.</p>
