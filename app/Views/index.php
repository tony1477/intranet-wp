                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-lg-6">
                        <div class="card point-level">
                            <div class="card-header align-items-center d-flex bg-info rounded">
                                <h4 class="card-title mb-0 flex-grow-1 fs-3 text-center text-white"><?=lang('Files.Point_Level')?></h4>
                                <!-- <div class="flex-shrink-0">
                                    <select class="form-select form-select-sm mb-0 my-n1" onchange="changeFunc()" id="select_day">
                                        <option value="Today">This Month</option>
                                        <option value="Yesterday">Last Month</option>
                                        <option value="Tomorrow">Last 2 Month</option>
                                    </select>
                                </div> -->
                            </div><!-- end card header -->
                            <div class="card-body px-0">
                                <div class="px-3" data-simplebar="init" style="max-height: 355px;"><div class="simplebar-wrapper" style="margin: 0px -16px;"><div class="simplebar-height-auto-observer-wrapper"><div class="simplebar-height-auto-observer"></div></div><div class="simplebar-mask"><div class="simplebar-offset" style="right: -15px; bottom: 0px;"><div class="simplebar-content-wrapper" style="height: auto; overflow: hidden scroll;"><div class="simplebar-content" style="padding: 0px 16px;">
                                    <ul class="list-unstyled activity-wid mb-0" id="ulPointLevel">
                                    <li class="bg-soft-success rounded w-50 info-point">
                                        <div class="timeline-list-item">
                                            <div class="flex-grow-1 overflow-hidden">
                                            <h3 class="text-success" style="line-height: 1.5;">Top 3 Best Point</h3>
                                            </div>
                                        </div>
                                    </li>
                                    <?php $i=3; 
                                    foreach($data['toppoint'] as $list):?>
                                    <li class="activity-list activity-border" id="liListPoint" style="top:-.7rem;">
                                        <div class="activity-icon avatar-lg photo-profile">
                                            <span class="avatar-title <?=($i==3) ? 'bg-golden' : (($i==2) ? 'bg-silver' : 'bg-bronze')?> text-warning rounded-circle">
                                            <img class="rounded-circle width-48 bg-secondary" src="<?=base_url()?>/public/assets/images/users/<?=$list->user_image?>" alt="Header Avatar">
                                            </span>
                                            <div class="star-level">
                                                <?php 
                                                if($i==3):?>
                                                <i class="fa fa-star star-rising star-left"></i>
                                                <i class="fa fa-star star-rising big-star"></i>
                                                <i class="fa fa-star star-rising star-right"></i>
                                                <?php elseif($i==2):?>
                                                    <i class="fa fa-star star-rising"></i>
                                                    <i class="fa fa-star star-rising"></i>
                                                <?php else:?>
                                                    <i class="fa fa-star star-rising"></i>
                                                <?php endif;?>
                                        ...
                                        <div class="timeline-list-item mt-3">
                                            <div class="d-flex">
                                                <div class="flex-grow-1 overflow-hidden me-4">
                                                    <h5 class="font-size-14 mb-1"><?=$list->name?></h5>
                                                    <p class="text-truncate text-muted "><?=$list->employeecode?></p>
                                                </div>
                                                <div class="flex-shrink-0 text-end me-3">
                                                    <h6 class="mb-1"><?=$list->totalpoint?>Pt</h6>
                                                    <div class="font-size-13"><?=$list->position?></div>
                                                </div>
                                    ...
                                    <!--
									<li class="bg-soft-warning rounded w-50 info-point">
                                        <div class="timeline-list-item">
                                            <div class="flex-grow-1 overflow-hidden">
                                            <h3 class="text-warning" style="line-height: 1.5;">Top 3 Lowest Point</h3>
                                            </div>
                                        </div>
                                    </li>
									-->

                                    <?php foreach($data['lowpoint'] as $bottom):?>
                                    <!-- <li class="activity-list activity-border" id="liListPoint" style="top:-.7rem;">
                                        <div class="activity-icon avatar-lg">
                                            <span class="avatar-title bg-bronze2 text-warning rounded-circle">
                                            <img class="rounded-circle width-48 p-1 bg-secondary" src="<?=base_url()?>/public/assets/images/users/default.png" alt="Header Avatar">
                                            </span>
                                        </div>
                                        <div class="timeline-list-item mt-3">
                                            <div class="d-flex">
                                                <div class="flex-grow-1 overflow-hidden me-4">
                                                    <h5 class="font-size-14 mb-1"><?=$bottom->name?></h5>
                                                    <p class="text-truncate text-muted "><?=$bottom->employeecode?></p>
                                                </div>
                                                <div class="flex-shrink-0 text-end me-3">
                                                    <h6 class="mb-1"><?=$bottom->totalpoint?> Pts</h6>
                                                    <div class="font-size-13"><?=$bottom->position?></div>
                                                </div>
                                            </div>
                                        </div> 
                                    </li>
                                    ...
                                    <li class="activity-list activity-border">
                                        <div class="timeline-list-item">
                                            <div class="flex-grow-1 overflow-hidden me-4">
                                                <a href="<?=base_url()?>/employee/points" class="font-size-14 mb-1">Lihat Semua Point</a>
                                            </div>
                                        </div>
                                    </li>
                                    </ul>
