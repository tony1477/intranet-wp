        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <div class="mb-3">
                            <h5 class="card-title"><?=lang('Files.Edit_Ticket')?><span class="text-muted fw-normal ms-2"><!-- INI DIISI NANTI --></span></h5>
                        </div>
                    </div>
                </div>
                <!-- end row -->                
                                    ...
                                    <?=form_hidden('user_reason', $data->user_reason);?>
                                        <div>
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" type="text" value="<?=get_username($data->userid_req)?>" name="username" id="input-username" readonly>
                                            </div>
                                            <div class="mb-3">
                                                <label for="input-userdate" class="form-label">Tanggal Request</label>
                                                <input class="form-control" type="date" value="<?=date('Y-m-d',strtotime($data->ticketdate))?>" name="userdate" id="input-userdate" readonly>
                                            </div>
                                            <div class="mb-3">
                                                <label for="input-usertelp" class="form-label">No Telepon</label>
                                                <input class="form-control" type="tel" name="usertelp" value="<?=$data->user_phone?>" id="input-usertelp">
                                            </div>
